    ...
    <div class="grid grid-cols-12 gap-6">
      ...
      >
        <div class="box mt-5">
          ...
          <div class="p-5 border-t flex dark:border-dark-5"></div>
        </div>
      </div>
      <!-- END: Profile Menu -->
        ...
        <div class="box lg:mt-5 tab-content__pane" id="change_password">
          ...
          <div class="p-5">
            <div>
              ...
              />
              <small v-if="error_old_password_text" class="text-theme-6">{{
            ...
            <div class="mt-3">
              ...
              />
              <small v-if="error_new_password_text" class="text-theme-6">{{
            ...
            <div class="mt-3">
              ...
              />
              <small v-if="error_confirm_password_text" class="text-theme-6">{{
        ...
        <div class="box lg:mt-5 tab-content__pane" id="change_email">
          ...
          <div class="p-5">
            <div>
              ...
              />
              <small v-if="error_old_email_text" class="text-theme-6">{{
                this.old_email_error
              }}</small>
            </div>
            <div class="mt-3">
              ...
              />
              <small v-if="error_new_email_text" class="text-theme-6">{{
                this.new_email_error
              }}</small>
            </div>
            <div class="mt-3">
              ...
              />
              <small v-if="error_password_text" class="text-theme-6">{{
                this.password_error
              }}</small>
            </div>
            <button
...
export default {
  ...
  mounted() {
    ...
    this.old_name = this.$store.state.main.user.Name;
  },
  methods: {
    changeEmail() {
      let self = this;
      ...
      axios
        ...
        .then((res) => {
          if (res.data.message == "success") {
            ...
            self.$store.dispatch("main/setUser", res.data.result.user);
          } else {
            Toastify({
              text: res.data.response,
              duration: 3000,
      ...
      axios
        ...
        .then((res) => {
          if (res.data.message == "success") {
            ...
            this.$store.dispatch("main/setUser", res.data.result.user);
          } else {
            Toastify({
              text: res.data.response,
              duration: 3000,
  ...
  watch: {
    old_email() {
      if (this.old_email == "") {
        ...
        this.error_old_email_text = true;
        this.old_email_error = "Invalied Email Format";
      } else {
    ...
    new_email() {
      if (this.new_email == "") {
        ...
        this.error_new_email_text = true;
        this.new_email_error = "Invalied Email Format";
      } else {
    ...
    old_password() {
      if (this.old_password == "") {
        ...
        this.error_old_password_text = true;
        this.old_password_error = "The old_password must be at least 6 characters!";
      } else {
    ...
    new_password() {
      if (this.new_password == "") {
        ...
        this.error_new_password_text = true;
        this.new_password_error = "The new_password must be at least 6 characters!";
      } else {
    ...
    confirm_password() {
      if (this.confirm_password == "") {
        ...
        this.confirm_password_error = "The password must be at least 6 characters!";
      } else {
